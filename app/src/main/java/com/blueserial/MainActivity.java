...
public class MainActivity extends Activity {
	...
	private SeekBar lenkBar;
	private SeekBar gasBar;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mgasView = (TextView) findViewById(R.id.gasView);
		mlenkView = (TextView) findViewById(R.id.lenkView);
		//mBtnClearInput = (Button) findViewById(R.id.btnClearInput);
		lenkBar = (SeekBar) findViewById(R.id.lenkBar);
		gasBar = (SeekBar) findViewById(R.id.gasBar);

		gasBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
			@Override
			public void onProgressChanged(SeekBar seekBar, int gasProgress, boolean b) {

				try {
					mBTSocket.getOutputStream().write(gasProgress);

				} catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
				mgasView.setText(Integer.toString(gasProgress));
			}
			...
			public void onStopTrackingTouch(SeekBar seekBar) {
				...
				try {
					mBTSocket.getOutputStream().write(10);
		...
		lenkBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
			@Override
		...
		mBtnEmergency.setOnClickListener(new OnClickListener() {
		...
		mlenkLinks.setOnClickListener(new OnClickListener() {
		...
		mlenkMid.setOnClickListener(new OnClickListener() {
